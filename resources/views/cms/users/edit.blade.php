...
@section('main-page-name',__('cms.doctor'))
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">{{__('cms.doctor')}}</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="specialty_id">{{__('cms.specialty')}}</label>
                                <select class="custom-select form-control-border" id="specialty_id">
                                   @foreach ($specialties as $specialtie)
                                    <option value="{{$specialtie->id}}"@if($user->specialty_id == $specialtie->id) selected
                                        @endif >{{$specialtie->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
