            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        @canany(['Create-Appointment','Read-Appointments','Create-Specialty','Read-Specialties'])
                        <li class="nav-header">{{__('cms.content_management')}}</li>
                        @canany(['Create-Specialty','Read-Specialties'])
                        ...
                        @canany(['Create-Appointment','Read-Appointments'])
