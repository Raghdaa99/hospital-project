                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                @foreach ($pateints as $pateint)
                                    <option value="{{$pateint->id}}">{{$pateint->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Date:</label>
                                 <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                     <input id="date_appointment" type="text" class="form-control datetimepicker-input" data-target="#reservationdate"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="timepicker" data-target-input="nearest">
                                    <input id="time_appointment" type="text" class="form-control datetimepicker-input" data-target="#timepicker">
